...
const ShopCards = ({ image, title, subtitle, price, button }) => {
  return (
    <div className="w-full max-w-40 mx-auto flex flex-col items-center rounded-md mb-4 bg-white">
      <div className="overflow-hidden">
        <img
          className="w-40 transform transition-transform duration-300 ease-in-out hover:scale-110 rounded-md shadow-lg"
          src={image}
          alt={title}
        />
      </div>
